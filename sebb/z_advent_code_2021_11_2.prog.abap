REPORT z_advent_code_2021_11_2.
...
DO.
  ...
  IF octopus_collection=>get_flashed_counter( ) = 100.
    RETURN.
  ENDIF.
  octopus_collection=>reset_flashed_counter( ).
  NEW-LINE.
ENDDO.
