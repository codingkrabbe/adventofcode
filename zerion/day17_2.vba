...
Next
    ...
    probey = 0
k = 0
    For velox = 0 To Tabelle16.Cells(1, 3) + 1
        For veloy = -200 To 200
        highy = 0
            probexvelo = velox
            probeyvelo = veloy
                probex = 0
    probey = 0
            ...
            hit = 1
            End If
            Loop Until probex > Tabelle16.Cells(1, 3) Or probey < Tabelle16.Cells(2, 3) Or hit = 1
            If hit = 1 Then
            Tabelle16.Cells(k + 3, 1) = velox
            Tabelle16.Cells(k + 3, 2) = veloy
    k = k + 1
            End If
       Next
         Next
